...
-- Tiempo de generación: 01-07-2024 a las 03:13:48
...
(61, 1, '¿Cuál es la salida del siguiente código en Python?\r\nprint(2  **  3  **  2)', '64', '512', '256', 'B'),
(62, 1, '¿Cuál es el valor de x después de ejecutar el siguiente código en C?\r\nint x = 5;\r\nx += 10;', '5', '10', '15', 'C'),
(63, 1, '¿Qué operador se usa para concatenar cadenas en Java?', '+', '&amp;', '*', 'A'),
(64, 1, '¿Qué es un closure en JavaScript?', 'Una función que tiene acceso a su ámbito léxico', 'Una clase que no se puede instanciar', 'Un método que no tiene parámetros', 'A'),
(65, 1, '¿Cuál es la salida del siguiente código en JavaScript?\r\nconsole.log(typeof null);', 'null', 'object', 'boolean', 'B'),
(66, 1, '¿Qué significa OOP en programación?', 'Object-Oriented Programming', 'Open Operations Programming', 'Operational Output Programming', 'A'),
(67, 1, '¿Cuál es la función principal de un constructor en una clase en C++?', 'Eliminar un objeto', 'Inicializar un objeto', 'Clonar un objeto', 'B'),
(68, 1, '¿Cuál es el valor de x después de ejecutar el siguiente código en Java?\r\nint x = 10;\r\nx = x++ + ++x;', '20', '21', '23', 'C'),
(69, 1, '¿Qué palabra clave se usa para heredar de una clase en Python?', 'inherits', 'extend', 'class', 'B'),
(70, 1, '¿Cuál es la salida del siguiente código en PHP?\r\necho 5 . 2 * 3;', '56', '5.2', '53', 'C');
